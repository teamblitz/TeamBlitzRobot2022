...
public class DriveStraightWithDelay extends CommandBase {
    ...
    public DriveStraightWithDelay(final DriveSubsystem driveSubsystem, final double voltage, final ShooterSubsystem shooterSubsystem, final BallMoverSubsystem ballMoverSubsystem) {
