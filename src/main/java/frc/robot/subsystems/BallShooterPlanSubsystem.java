...
public class BallShooterPlanSubsystem extends SubsystemBase {
    ...
    private double m_maxDriveSpeedFraction = 0.60; // how fast we allow the autodrive code to dictate we want to go
    ...
    public void periodic() {
        ...
        if(m_LimelightTargetSubsystem.getValid() > 0)
        {
            ...
            double driveSpeedFraction = 0.4 * (Math.abs(ty)) / m_maxOffsetFraction; // results in [0.0 ... 1.0]
