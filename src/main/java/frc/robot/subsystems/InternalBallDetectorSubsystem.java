...
public class InternalBallDetectorSubsystem extends SubsystemBase {
    ...
    /**
     * A Rev Color Sensor V3 object is constructed with an I2C port as a parameter. The device will
     * be automatically initialized with default parameters.
     */
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber(
                "Distance From Blue", CalculateDistance(detectedColor, kBlueTarget));
