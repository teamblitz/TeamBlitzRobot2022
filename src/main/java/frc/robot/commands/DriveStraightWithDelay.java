...
public class DriveStraightWithDelay extends CommandBase {
    ...
    private boolean driveBack =
            true; // Do we need to drive back? if our ball detector was active recently then this
    // won't activate as we got a ball

    public DriveStraightWithDelay(
    ...
    public void initialize() {
        ...
        // driveBack = internalBallDetectorSubsystem.lastSeen() < 7000; //If we haven't seen the
        // ball via internal detector in 7 seconds we need to drive backwords as our bot didn't pick
        // up the ball
    }
